          ...
          <Flex gap={12} direction={{ base: "column", md: "row" }}>
            <Box display={"grid"} alignItems={"center"}>
              ...
              <Text mt={5}>
                ...
                kind with anyone. We will not sell or rent your name or personal
              ...
              <Text mt={5}>
                Chakra UI Pro may release personal information if Chakra UI Pro
                is required to by law, search warrant, subpoena, court order or
                fraud investigation. We may also use personal information in a
                manner that does not identify you specifically nor allow you to
                be contacted but does identify certain criteria about our Site
                {`'`}s users in general (such as we may inform third parties
                about the number of registered users, number of unique visitors,
                and the pages most frequently browsed).
              </Text>
              <br />
